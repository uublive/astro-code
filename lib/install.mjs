...
// Claude Code's config dir is ~/.claude by default but is relocatable via
// CLAUDE_CONFIG_DIR (profile managers like "jean-claude" set this). Honor it so
// commands/agents land where the ACTIVE profile actually reads them.
