...
/** Render every source file of one kind through a host and publish it. */
function publishKind(host, frameworkRoot, dir, kind) {
  ...
  return publishFiles(out, join(dir, host.placement[kind]));
}
