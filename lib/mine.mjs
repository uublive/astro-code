...
// the `/astro-principles-mine` agent a bounded batch of the turns the human actually typed, and
...
// pointer-only run record (`lib/minestate.mjs`). `/astro-principles-mine` is the one that groups,
