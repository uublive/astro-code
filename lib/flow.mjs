...
// parseCompareUrl — stub placeholder for t1 tests (t2 implements the real function).
// Returns null unconditionally; replaced in t2 with full HTTPS/SSH/ssh:// parsing
// for github.com, gitlab.com, GHES (*.github.com), and self-hosted gitlab.* hosts.
// eslint-disable-next-line no-unused-vars
export function parseCompareUrl(_remoteUrl, _base, _head) { return null }
